...
insert into user_role(role, description) VALUES ("ROLE_BOSS", "default role for boss");
insert into user_role(role, description) VALUES ("ROLE_MANAGER", "default role for manager");
